...
amertrends_clean |> 
  ...
  labs(x = "Economic Perception",
       ...
       title = "Figure 2. Support for Autocratic Leadership by Economic \nPerception and Political Leaning")
```

### Statistical Analysis

Table 1 below summarizes the multiple logistic regression model for autocratic leadership support. 
